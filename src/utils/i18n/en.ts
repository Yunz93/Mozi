export default {
  ...
  table_insertPickerHint: "Choose size",
  table_insertSize: "{rows} × {cols}",
  table_insertSized: "Insert {rows}×{cols} table",
  table_columnPrefix: "Col",
  slash_calloutNote: "Insert note",
  slash_calloutWarning: "Insert warning",
  slash_calloutCaution: "Insert caution",
  slash_calloutHint: "Callout",
  slash_calloutTitleNote: "Note",
  slash_calloutTitleWarning: "Warning",
  slash_calloutTitleCaution: "Caution",
  slash_placeholderBody: "Content",
  slash_mermaidFlow: "Insert flowchart",
  slash_mermaidSequence: "Insert sequence diagram",
  slash_mermaidHint: "Mermaid",
  slash_mermaidStart: "Start",
  slash_mermaidStep: "Step",
  slash_mermaidEnd: "End",
  slash_mermaidClient: "Client",
  slash_mermaidServer: "Server",
  slash_mermaidRequest: "Request",
  slash_mermaidResponse: "Response",
  slash_mathBlock: "Insert equation",
  slash_mathHint: "Block math",
  slash_codeFence: "Insert code block",
  slash_codeHint: "Choose language",
  slash_wikiEmbed: "Embed note",
  slash_wikiEmbedHint: "Wiki embed",
  slash_footnote: "Insert footnote",
  slash_footnoteHint: "Definition at end",
