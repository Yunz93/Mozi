export default {
  ...
  table_insert: "插入表格",
  table_insertPickerHint: "选择行列",
  table_insertSize: "{rows} × {cols}",
  table_insertSized: "插入 {rows}×{cols} 表格",
  table_columnPrefix: "列",
  slash_calloutNote: "插入提示",
  slash_calloutWarning: "插入警告",
  slash_calloutCaution: "插入注意",
  slash_calloutHint: "高亮块",
  slash_calloutTitleNote: "提示",
  slash_calloutTitleWarning: "警告",
  slash_calloutTitleCaution: "注意",
  slash_placeholderBody: "内容",
  slash_mermaidFlow: "插入流程图",
  slash_mermaidSequence: "插入时序图",
  slash_mermaidHint: "Mermaid",
  slash_mermaidStart: "开始",
  slash_mermaidStep: "步骤",
  slash_mermaidEnd: "结束",
  slash_mermaidClient: "客户端",
  slash_mermaidServer: "服务",
  slash_mermaidRequest: "请求",
  slash_mermaidResponse: "响应",
  slash_mathBlock: "插入公式",
  slash_mathHint: "块级公式",
  slash_codeFence: "插入代码块",
  slash_codeHint: "选择语言",
  slash_wikiEmbed: "嵌入笔记",
  slash_wikiEmbedHint: "Wiki 嵌入",
  slash_footnote: "插入脚注",
  slash_footnoteHint: "文末定义",
