...
- 画板: [Excalidraw](https://excalidraw.com/)（`.excalidraw` 与 Obsidian `.excalidraw.md` 编辑、笔记内嵌预览；Obsidian 默认 `compressed-json` 使用 LZ-String；字体经 Vite 插件自托管到 `public/fonts`，`EXCALIDRAW_ASSET_PATH=/`）
